    ...
    <section className="bg-cinzaFooter">
      <div className="w-full max-w-lg md:max-w-4xl mx-auto pb-32 px-10 sm:px-7 md:px-3 flex flex-col items-center gap-5">
        ...
        <div className="w-full flex sm:flex-row items-center justify-center gap-2 sm:justify-between">
          ...
          <a href="#" className='px-3 sm:px-10 py-2 sm:py-4 w-fit flex items-center justify-center gap-2 bg-azul border border-azul hover:bg-azulHover transition-all text-branco font-medium text-base md:text-lg rounded-lg'>
        ...
        <div className="flex flex-col items-center justify-center gap-5 w-auto">
          ...
          <div className="w-full sm:w-fit flex flex-col justify-between items-start gap-6 px-7 py-10 rounded-2xl bg-white text-shadow shadow-zinc-500/20 shadow-[3px_3px_6px_2px_#383b3f34]">
