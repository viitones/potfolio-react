export function Graduacoes(){
    return(
        <div className="flex flex-col md:flex-row justify-between gap-6 items-center px-7 py-10 rounded-2xl bg-white text-shadow shadow-zinc-500/20 shadow-[3px_3px_6px_2px_#383b3f34]">
